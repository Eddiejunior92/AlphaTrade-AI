...
- **Database**: PostgreSQL — `portfolio`, `holdings` (composite PK), `trades`, `audit_log`, `historical_intelligence`, `symbol_strategy_performance`, `model_performance`, `backtest_runs`, `company_knowledge`, `rl_q_table`.
